...
#define ST24_RECEIVER	0
#define DSM_RECEIVER	1
#define PPM_RECEIVER	2
#define RECEIVER_TYPE	ST24_RECEIVER
...
//
// This class is for YUNEEC receiver
//
#define ST24_POWER_PIN			PC8
