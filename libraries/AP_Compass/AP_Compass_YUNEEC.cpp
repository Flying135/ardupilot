...
/*
 *       AP_Compass_YUNEEC.cpp - Arduino Library for HMC5843 I2C magnetometer
...
bool AP_Compass_YUNEEC::read_register(uint8_t address, uint8_t *value)
{
...
bool AP_Compass_YUNEEC::write_register(uint8_t address, uint8_t value)
{
...
// Read Sensor data
bool AP_Compass_YUNEEC::read_raw()
{
    uint8_t buff[6];
...
void AP_Compass_YUNEEC::accumulate(void)
{
    if (!_initialised) {
   ...
   // suspend timer procs in order of conflict reading on the same I2C bus
 ...
 */
bool AP_Compass_YUNEEC::re_initialise()
{
