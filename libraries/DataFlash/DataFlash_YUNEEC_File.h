...
#ifndef DataFlash_YUNEEC_File_h
#define DataFlash_YUNEEC_File_h
...
class DataFlash_YUNEEC_File : public DataFlash_Class
{
public:
    // constructor
    DataFlash_YUNEEC_File(const char *log_directory);
...
private:
    ...
    const char *_last_log_directory;
    /*
      read a block
    */
